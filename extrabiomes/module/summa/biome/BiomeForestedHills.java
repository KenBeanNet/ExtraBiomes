...
public class BiomeForestedHills extends ExtrabiomeGenBase
{
    public BiomeForestedHills()
    {
        ...
        this.setBiomeName("Forested Hills");
    ...
    {
        return ColorizerFoliage.getFoliageColor(0.800000011920929D, 1.0D);
    }
    ...
    {
        return ColorizerGrass.getGrassColor(0.800000011920929D, 1.0D);
    }
